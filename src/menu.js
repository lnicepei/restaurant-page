function createMenu() {
    ...
    container1.className = 'menu-element';
    ...
    container2.className = 'menu-element';
    ...
    container3.className = 'menu-element';
    ...
    container4.className = 'menu-element';
    ...
    container5.className = 'menu-element';
    ...
    container6.className = 'menu-element';
